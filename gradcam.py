...
""" load & preprocess imgs """
img = Image.open('./Black_Footed_Albatross_0001_796111.jpg')
...
output = vgg.fc8    # the layer with output scores before the softmax layer 
...
# show the cam
plt.imshow(img.resize([config["img_W"], config["img_H"]]), cmap = 'gray' )
